...
export function ImageUpload({
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-dashed border-[var(--organisation-border)] bg-[var(--organisation-background)] p-5">
                {value ? (
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
                        <div className="flex h-32 w-32 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-[var(--organisation-border)] bg-[var(--organisation-surface)] p-3 shadow-sm">
                            <img
                                src={value}
                                alt={
                                    previewAlt ??
                        ...
                        <div className="flex flex-1 flex-wrap gap-3">
                            <button
                                ...
                                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-[var(--organisation-border)] bg-[var(--organisation-surface)] px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-[var(--organisation-background)] disabled:cursor-not-allowed disabled:opacity-60"
                            >
                    ...
                    <div className="flex flex-col items-center justify-center px-4 py-6 text-center">
                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--organisation-surface)] text-[var(--organisation-accent)]">
