...
export const fixtures: Fixture[] = [
  {
    ...
    time: '10:00',
    venue: 'Festival Pitch 1',
    homeTeam: 'Opening Match Team A',
    awayTeam: 'Opening Match Team B',
    status: 'Upcoming',
  },
  {
    id: 2,
    ...
    time: '12:00',
    venue: 'Festival Pitch 2',
    homeTeam: 'Group A Team',
    awayTeam: 'Group B Team',
    status: 'Upcoming',
  },
  {
    id: 3,
...
export const articles: Article[] = [
  {
    ...
    slug: 'black-footballers-in-the-uk',
    title: 'Black Footballers in the UK',
    category: 'Black Football History',
    status: 'published',
    summary:
        'A short introduction to the players and coaches who helped shape British football and opened doors for future generations.',
    hero:
        'From early pioneers to modern icons, Black footballers have changed the game in the UK on the pitch, in the dugout and across the wider football community.',
    readTime: '4 min read',
    body: [
    ...
    actions: [
      {
        label: 'National Football Museum Hall of Fame',
        href: 'https://nationalfootballmuseum.com/hall-of-fame/',
      },
      {
        label: 'Football Unites: Pioneering Black Footballers',
        href: 'https://furd.org/resources/pioneering-black-footballers',
      },
    ],
  },
  {
    ...
    slug: 'local-heroes',
    title: 'Local Heroes',
    category: 'Coach & Volunteer Spotlights',
    status: 'published',
    summary:
        'Celebrating the coaches, referees, volunteers, parents and organisers who keep grassroots football alive every week.',
    hero:
        'Black History Month is also about recognising the people who serve the community quietly, consistently and with purpose.',
    readTime: '3 min read',
    body: [
  ...
  },
  {
    ...
    slug: 'education-and-legacy',
    title: 'Education and Legacy',
    category: 'Opinion & Education',
    status: 'published',
    summary:
        'Youth-friendly resources that connect football, identity, leadership, teamwork and Black British history.',
    hero:
        'The festival should be entertaining, but it should also leave young people with knowledge, confidence and a stronger sense of belonging.',
    readTime: '3 min read',
    body: [
  ...
  },
  {
    ...
    category: 'Sponsor & Partner Stories',
    status: 'published',
    summary:
        'A space to highlight local businesses, sponsors and community partners supporting the festival.',
    hero:
        'Grassroots football grows stronger when local businesses and local communities work together.',
    readTime: '3 min read',
    body: [
    ...
    author: 'CKEFA Media Partnerships Team',
